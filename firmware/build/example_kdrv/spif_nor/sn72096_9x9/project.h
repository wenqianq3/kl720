...
#define KDRV_PIN_X_PWM1_REG                     PIN_MODE_2 | (PIN_PULL_NONE << 16) | (PIN_DRIVING_12MA << 21)           //0x00400003   Pinmode:DPI_DATAO[12]
...
#define OS_DYNAMIC_MEM_SIZE         (1024*12)
...
#define KDP_DDR_MODEL_RESERVED_END      0x82FFFFFF

/** DDR DDR HEAP HEAD for malloc */
#define KDP_DDR_HEAP_HEAD_FOR_MALLOC    0x83FCFFFF // heap grows upward

/** Reserve for system information */
#define KDP_DDR_BASE_SYSTEM_RESERVED    0x83FD0000 // reserved 191 KB

/** Reserve for fw_info.bin */
#define KDP_DDR_MODEL_INFO_TEMP         0x85FFF000 // 4KB

#define KDP_DDR_END                     0x83FFFFFF
/** @} */
...
=============================================================================*/
/* Flash table */
#define FLASH_FW_SCPU0_ADDR                 0x00008000
#define FLASH_FW_NCPU0_ADDR                 0x00028000
#define FLASH_FW_CFG0_ADDR                  0x00228000
#define FLASH_FW_SCPU1_ADDR                 0x00229000
#define FLASH_FW_NCPU1_ADDR                 0x00249000
#define FLASH_FW_CFG1_ADDR                  0x00449000
#define FLASH_FID_MAP_ADDR                  0x0044A000
#define FLASH_MODEL_FW_INFO_ADDR            0x004CA000
#define FLASH_MDDEL_ALL_ADDR                0x004CB000
...
#define DDR_HEAP_END                        0x86000000      // 32MB to DDR_HEAP_BEGIN
