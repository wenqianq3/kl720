...
#define FLASH_SIZE                              FLASH_SIZE_64MBIT
...
#define KDRV_PIN_X_SSP0_CLK_REG                 PIN_MODE_0 | (PIN_PULL_UP << 16) | (PIN_DRIVING_12MA << 21)           //0x00400000   Pinmode:SSP0_CLK
...
#define KDRV_PIN_X_SSP0_DI_REG                  PIN_MODE_0 | (PIN_PULL_UP << 16) | (PIN_DRIVING_12MA << 21)           //0x00400000   Pinmode:SSP0_DI
#define KDRV_PIN_X_SSP0_DO_REG                  PIN_MODE_0 | (PIN_PULL_UP << 16) | (PIN_DRIVING_12MA << 21)           //0x00400000   Pinmode:SSP0_DO
#define KDRV_PIN_X_SSP1_CLK_REG                 PIN_MODE_0 | (PIN_PULL_UP << 16) | (PIN_DRIVING_12MA << 21)           //0x00400001   Pinmode:DPI_DATAO[13]
#define KDRV_PIN_X_SSP1_CS_REG                  PIN_MODE_0 | (PIN_PULL_DOWN << 16) | (PIN_DRIVING_12MA << 21)           //0x00400001   Pinmode:DPI_DATAO[14]
#define KDRV_PIN_X_SSP1_DI_REG                  PIN_MODE_0 | (PIN_PULL_UP << 16) | (PIN_DRIVING_12MA << 21)           //0x00400001   Pinmode:DPI_DATAO[15]
#define KDRV_PIN_X_SSP1_DO_REG                  PIN_MODE_0 | (PIN_PULL_UP << 16) | (PIN_DRIVING_12MA << 21)           //0x00400001   Pinmode:DPI_DATAO[16]
#define KDRV_PIN_X_SSP1_DCX_REG                 PIN_MODE_0 | (PIN_PULL_NONE << 16) | (PIN_DRIVING_12MA << 21)           //0x00400001   Pinmode:DPI_DATAO[17]
...
#define OS_DYNAMIC_MEM_SIZE         (1024*15)
...
#define DDR_HEAP_END                        0x85E00000      // 32MB to DDR_HEAP_BEGIN + 2MB
