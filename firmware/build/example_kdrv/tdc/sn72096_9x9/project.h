...
=============================================================================*/
    ...
    #define I2C_ATTR_ARRAY                          {\
                                                    {I2C_PORT,               COMM_I2C_SPEED_400K,            0x50} };
#endif
...
#define KDRV_PIN_X_PWM1_REG                     PIN_MODE_3 | (PIN_PULL_NONE << 16) | (PIN_DRIVING_12MA << 21)           //0x00400003   Pinmode:DPI_DATAO[12]
...
/*=============================================================================
DDR configuration    //pattaya_todo
=============================================================================*/
...
#define KDP_DDR_MODEL_INFO_TEMP         0x85030000 // 4KB
...
#define NCPU_IMAGE_SIZE                     (NCPU_IMAGE_IRAM_SIZE + NCPU_IMAGE_DDR_SIZE)
