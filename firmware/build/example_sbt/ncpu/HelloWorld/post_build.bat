...
%UTILS_PATH%\dfu\gen_dfu_binary_for_win.exe -ncpu fw_ncpu_tmp.bin fw_ncpu.bin
copy fw_ncpu.bin %UTILS_PATH%\bin_gen\flash_bin
copy fw_ncpu.bin %UTILS_PATH%\JLink_programmer\bin
