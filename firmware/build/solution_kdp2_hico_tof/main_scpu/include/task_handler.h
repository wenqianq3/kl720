...
extern void kdp2_hico_tof_usb_cmd_thread(void *arg);
extern void kdp2_hico_tof_usb_result_thread(void *arg);
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
  {"buf_mgr",       &task_buf_mgr_handle,       kdp2_fifoq_manager_enqueue_image_thread,        1024,       osPriorityHigh,         NULL,               0,         0    }, // Priority High due to avoid no buffer in real queue

//Application specific threads
  {"usbcmd",        &task_usb_cmd_handle,       kdp2_hico_tof_usb_cmd_thread,                   2048,       osPriorityNormal,       &qUsbrcevMgrSched,  16,        16   },
  {"usbrslt",       &task_usb_result_handle,    kdp2_hico_tof_usb_result_thread,                2048,       osPriorityNormal,       &qUsbsendMgrSched,  16,        16   },
