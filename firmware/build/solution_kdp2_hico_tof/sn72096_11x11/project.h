...
#define FLASH_COMM                              FLASH_COMM_SPEED_50MHZ
...
#define IMGSRC_0_SENSORID                       SENSOR_ID_IRS2877C
#define IMGSRC_0_DEV_ADDR                       0x3D
...
#define IMGSRC_0_HEIGHT                         (2169)
#define IMGSRC_0_TILE_AVG                       0
#define IMGSRC_0_MIPI_LANE                      2

#define IMGSRC_1_IN_PORT                        IMG_SRC_IN_PORT_NONE
...
#define CSIRX_0_VSTER                           CSIRX_VSTER_IRS2877C
...
#define D2A_1_FIFO_THRE                         D2A_FT_SC132GS
...
#define I2C_ATTR_ARRAY                          {\
                                                {COMM_PORT_ID_2,               COMM_I2CSPEED_0,            0x30, COMM_I2CMODE_MASTER} };
/*=============================================================================
Pinmux setting
=============================================================================*/
#define PIN_NUM                                 92
...
#define KDRV_PIN_X_I2C2_CLK_REG                 PIN_MODE_0 | (PIN_PULL_UP << 16) | (PIN_DRIVING_12MA << 21)           //0x00400000   Pinmode:I2C2_CLK
#define KDRV_PIN_X_I2C2_DATA_REG                PIN_MODE_0 | (PIN_PULL_UP << 16) | (PIN_DRIVING_12MA << 21)           //0x00400000   Pinmode:I2C2_DATA
...
#define KDRV_PIN_X_TRACE_DATA2_REG              PIN_MODE_7 | (PIN_PULL_DOWN << 16) | (PIN_DRIVING_12MA << 21)           //0x00400000   Pinmode:MCU_TRACE_DATA[2]
...
#define GPIO_ATTR_ARRAY                         {\
                                                ...
                                                {GPIO_PIN_20,   GPIO_DIR_OUTPUT | GPIO_OUT_LOW} };
...
#define FLASH_TOF_BUF_ADDR                  0x04000000
...
#define DDR_SCATTER_SPACE_SIZE              0x00000000      //reserve ? MBytes for ARM scatter
                                                            ...
                                                            //leave it as zero
//ToF Depth Buf
#define DDR_MEM_TOF_DEPTH_BEGIN             (DDR_SCATTER_SPACE_BASE+DDR_SCATTER_SPACE_SIZE)
#define DDR_MEM_TOF_P1_TABLE                (DDR_MEM_TOF_DEPTH_BEGIN)
#define DDR_MEM_TOF_P1_TABLE_SIZE           (640*240*2)
#define DDR_MEM_TOF_P2_TABLE                (DDR_MEM_TOF_P1_TABLE+DDR_MEM_TOF_P1_TABLE_SIZE)
#define DDR_MEM_TOF_P2_TABLE_SIZE           (640*240*2)
#define DDR_MEM_TOF_SHIFT_TABLE             (DDR_MEM_TOF_P2_TABLE+DDR_MEM_TOF_P2_TABLE_SIZE)
#define DDR_MEM_TOF_SHIFT_TABLE_SIZE        (640*240*2)
#define DDR_MEM_TOF_NON_LINEAR              (DDR_MEM_TOF_SHIFT_TABLE+DDR_MEM_TOF_SHIFT_TABLE_SIZE)
#define DDR_MEM_TOF_NON_LINEAR_SIZE         (4096*2)
#define DDR_MEM_TOF_GAMMA_TABLE             (DDR_MEM_TOF_NON_LINEAR+DDR_MEM_TOF_NON_LINEAR_SIZE)
#define DDR_MEM_TOF_GAMMA_TABLE_SIZE        (256*2)
#define DDR_MEM_TOF_CALI_TABLE              (DDR_MEM_TOF_GAMMA_TABLE+DDR_MEM_TOF_GAMMA_TABLE_SIZE)
#define DDR_MEM_TOF_CALI_TABLE_SIZE         (96*4)
#define DDR_MEM_TOF_TEMPERATURE_COEFF       (DDR_MEM_TOF_CALI_TABLE+DDR_MEM_TOF_CALI_TABLE_SIZE)
#define DDR_MEM_TOF_TEMPERATURE_COEFF_SIZE  (3*4)
#define DDR_MEM_TOF_USER_SETTING            (DDR_MEM_TOF_TEMPERATURE_COEFF+DDR_MEM_TOF_TEMPERATURE_COEFF_SIZE)
#define DDR_MEM_TOF_USER_SETTING_SIZE       (1*4)
#define DDR_MEM_TOF_IR_CAM_PARAMS           (DDR_MEM_TOF_USER_SETTING+DDR_MEM_TOF_USER_SETTING_SIZE)
#define DDR_MEM_TOF_IR_CAM_PARAMS_SIZE      (10*4)
#define DDR_MEM_TOF_DEPTH_SIZE              (DDR_MEM_TOF_IR_CAM_PARAMS+DDR_MEM_TOF_IR_CAM_PARAMS_SIZE-DDR_MEM_TOF_DEPTH_BEGIN)

#define DDR_HEAP_BEGIN                      0x88000000      // 128MB from base 0x80000000
#define DDR_HEAP_END                        (DDR_SCATTER_SPACE_BASE+DDR_MEM_TOF_DEPTH_SIZE)
