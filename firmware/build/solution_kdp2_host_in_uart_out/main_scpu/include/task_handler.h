...
osThreadId_t task_uart_cmd_handle;
osThreadId_t task_uart_result_handle;
...
osMessageQueueId_t qUartrcevMgrSched;
osMessageQueueId_t qUartsendMgrSched;
...
extern void kdp2_host_recv_usb_cmd_thread(void *arg);
extern void kdp2_host_recv_uart_cmd_thread(void *arg);
...
//                                                                                                                                                      MsgCount   MsgSize
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  {"LogTask",       &task_log_handle,           logger_thread,                                  2048,       osPriorityNormal,       &qLogMgrSched,      16,        16  },
...
//Application specific threads
  {"usbcmd",        &task_usb_cmd_handle,       kdp2_host_recv_usb_cmd_thread,                  2048,       osPriorityNormal,       &qUsbrcevMgrSched,  16,        16  },
  {"uartcmd",       &task_uart_cmd_handle,      kdp2_host_recv_uart_cmd_thread,                 2048,       osPriorityNormal,       &qUartrcevMgrSched, 16,        16  },
  {"uartrslt",      &task_uart_result_handle,   kdp2_host_update_result_thread,                 2048,       osPriorityNormal,       &qUartsendMgrSched, 16,        16  },
